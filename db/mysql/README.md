...
Phase 3 also adds two reviewed source views:
...
6. rollback ordering;
7. explicit `NOT EXECUTED` confirmation.
...
Migration order is `001 -> 002 -> 003 -> 004`. Rollback must run in reverse order: `004 -> 003 -> 002 -> 001`.

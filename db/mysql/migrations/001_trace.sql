...
CREATE TABLE agent_span (
	...
	created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
	PRIMARY KEY (span_id),
	KEY idx_agent_span_trace_started (trace_id, started_at),
...
CREATE TABLE llm_call (
	...
	created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
	PRIMARY KEY (call_id),
	KEY idx_llm_call_trace_started (trace_id, started_at),
...
CREATE TABLE tool_call (
	...
	created_at DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
	PRIMARY KEY (call_id),
	KEY idx_tool_call_trace_started (trace_id, started_at),
...
CREATE TABLE retrieval_event (
	...
	KEY idx_retrieval_event_trace_started (trace_id, started_at),
...
CREATE TABLE agent_error (
	...
	KEY idx_agent_error_trace_created (trace_id, created_at),

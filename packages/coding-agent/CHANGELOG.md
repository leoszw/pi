...
- Added a `chatMaxWidth` setting (default: 120): terminals wider than the cap center the transcript and input dock on a shared column; `0` restores full-width rendering.
